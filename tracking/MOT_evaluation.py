...
if __name__ == "__main__":
    ...
    ap.add_argument("-detCSV", "--detCSV", type=str, help="Path to tracking CSV file", default='')
    ap.add_argument("-gtCSV", "--gtCSV", type=str, help="Path to ground truth CSV file", default='')

    ap.add_argument("-task", "--task", type=str, help="What kind of tracking to investigate [3D, cam1, cam2, cam1_bbox, cam2_bbox]", default='3D')
