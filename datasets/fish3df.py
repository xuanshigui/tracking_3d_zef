...
class Fish3dF(GenericDataset):
    num_classes = 2
    num_joints = 17
    default_resolution = [960, 1280]
    max_objs = 1000
    class_name = ['imgF', 'imgT']
    cat_ids = {1: 1, 2: 2}

    def __init__(self, opt, split):
        super(Fish3dF, self).__init__()
        ...
        print('==> initializing Fish3d {} data.'.format(split))

        self.images = None
        # load image list and coco
        super(Fish3dF, self).__init__(opt, split, ann_path, img_dir)
